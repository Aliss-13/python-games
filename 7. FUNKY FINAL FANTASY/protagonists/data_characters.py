...
CHARACTERS = [
    ...
    Character(
        ...
        base_stats = {"life_max": 70, "mana_max" : 50, "power": 15,"speed": 12, "defense": 8}, 
        effects = [],
        level = 1,
        xp = 0,
    ...
    Character(
        ...
        base_stats = {"life_max": 70, "mana_max": 50, "power": 20, "speed": 10, "defense": 8},
        effects = [],
        level = 1,
        xp = 0,
        equipment = {"weapon" : None, "head" : None, "chest" : None, "hands" : None, "legs" : None, "feet" : None},
    ...
    Character(
        ...
        base_stats = {"life_max": 100, "mana_max": 0, "power": 20,"speed": 8, "defense": 10},
        effects = [],
        level = 1,
        xp = 0,
        equipment = {"weapon" : None, "head" : None, "chest" : None, "hands" : None, "legs" : None, "feet" : None},
